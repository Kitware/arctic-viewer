var // Core viewer builder
    viewerBuilder = require('./types'),

    // Image builder for ensemble
    PixelOperatorImageBuilder = require('tonic-core/lib/builder/image/PixelOperator'),

    // Painters
    MagicLensImageBuilder = require('tonic-core/lib/builder/image/MagicLens'),
    LineChartPainter = require('tonic-core/lib/painter/LineChart'),

    // React UI map
    ReactClassMap = {
        ArcticListViewer  : require('./viewer'),
        GenericViewer     : require('tonic-ui/lib/react/viewer/ImageBuilder'),
        GeometryViewer    : require('tonic-ui/lib/react/viewer/Geometry'),
        MultiViewerWidget : require('tonic-ui/lib/react/viewer/MultiLayout'),
        ProbeViewerWidget : require('tonic-ui/lib/react/viewer/Probe3D'),
        ViewerSelector    : require('tonic-ui/lib/react/widget/ButtonSelector')
    },
